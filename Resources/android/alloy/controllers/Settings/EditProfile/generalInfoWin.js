...
function Controller() {
    ...
    __alloyId185.push($.__views.pictureView.getViewEx({
        recurse: true
    }));
    ...
    $.__views.__alloyId186.add($.__views.fullName);
    ...
    $.__views.__alloyId190.add($.__views.marital_status);
    ...
    $.__views.__alloyId190.add($.__views.marital_status_privacy);
    ...
    __alloyId185.push($.__views.__alloyId192);
    ...
    __alloyId185.push($.__views.__alloyId193);
    ...
    $.__views.__alloyId193.add($.__views.gender_privacy);
    ...
    __alloyId185.push($.__views.__alloyId195);
    ...
    $.__views.__alloyId195.add($.__views.gender);
    ...
    __alloyId185.push($.__views.__alloyId196);
    ...
    __alloyId185.push($.__views.__alloyId197);
    ...
    $.__views.__alloyId197.add($.__views.birthday_date_privacy);
    ...
    __alloyId185.push($.__views.__alloyId199);
    ...
    $.__views.__alloyId199.add($.__views.birthday_date);
    ...
    __alloyId185.push($.__views.__alloyId200);
    ...
    __alloyId185.push($.__views.__alloyId201);
    ...
    AddRowButtonClicked ? $.__views.__alloyId203.addEventListener("click", AddRowButtonClicked) : __defers["$.__views.__alloyId203!click!AddRowButtonClicked"] = true;
    ...
    __alloyId185.push($.__views.__alloyId204);
    ...
    __alloyId185.push($.__views.__alloyId205);
    ...
    AddRowButtonClicked ? $.__views.__alloyId207.addEventListener("click", AddRowButtonClicked) : __defers["$.__views.__alloyId207!click!AddRowButtonClicked"] = true;
    ...
    __alloyId185.push($.__views.__alloyId208);
    $.__views.__alloyId209 = Ti.UI.createTableViewRow({
        editable: false,
        height: 50,
        id: "__alloyId209"
    });
    __alloyId185.push($.__views.__alloyId209);
    ...
    $.__views.__alloyId209.add($.__views.residence);
    ...
    $.__views.__alloyId209.add($.__views.residence_privacy);
    ...
    __defers["$.__views.__alloyId203!click!AddRowButtonClicked"] && $.__views.__alloyId203.addEventListener("click", AddRowButtonClicked);
    __defers["$.__views.__alloyId207!click!AddRowButtonClicked"] && $.__views.__alloyId207.addEventListener("click", AddRowButtonClicked);
