function Controller() {
    ...
    $.__views.editView.add($.__views.__alloyId159);
    ...
    $.__views.__alloyId159.add($.__views.fieldTitle);
    ...
    $.__views.__alloyId159.add($.__views.fieldValue);
    ...
    $.__views.editView.add($.__views.__alloyId160);
    Zeby ? $.__views.__alloyId160.addEventListener("click", Zeby) : __defers["$.__views.__alloyId160!click!Zeby"] = true;
    exports.destroy = function() {};
    _.extend($, $.__views);
    __defers["$.__views.__alloyId158!click!Zeby"] && $.__views.__alloyId158.addEventListener("click", Zeby);
    __defers["$.__views.__alloyId160!click!Zeby"] && $.__views.__alloyId160.addEventListener("click", Zeby);
    _.extend($, exports);
}
