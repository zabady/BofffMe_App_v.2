function Controller() {
    ...
    $.__views.editView.add($.__views.__alloyId131);
    Zeby ? $.__views.__alloyId131.addEventListener("click", Zeby) : __defers["$.__views.__alloyId131!click!Zeby"] = true;
    ...
    $.__views.editView.add($.__views.__alloyId132);
    ...
    $.__views.__alloyId132.add($.__views.fieldTitle);
    ...
    $.__views.__alloyId132.add($.__views.fieldValue);
    ...
    _.extend($, $.__views);
    __defers["$.__views.__alloyId131!click!Zeby"] && $.__views.__alloyId131.addEventListener("click", Zeby);
