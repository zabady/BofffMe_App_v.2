...
function Controller() {
    ...
    $.__views.qrCodeWin.leftNavButton = $.__views.__alloyId22;
    ...
    $.__views.qrCodeWin.add($.__views.__alloyId23);
    ...
    scanBtnClicked ? $.__views.__alloyId24.addEventListener("click", scanBtnClicked) : __defers["$.__views.__alloyId24!click!scanBtnClicked"] = true;
    ...
    $.__views.view_overlay.add($.__views.__alloyId25);
    openCloseLedBarcode ? $.__views.__alloyId25.addEventListener("click", openCloseLedBarcode) : __defers["$.__views.__alloyId25!click!openCloseLedBarcode"] = true;
    ...
    cancelBarcode ? $.__views.__alloyId26.addEventListener("click", cancelBarcode) : __defers["$.__views.__alloyId26!click!cancelBarcode"] = true;
