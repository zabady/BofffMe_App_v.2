function Controller() {
    ...
    $.__views.__alloyId96.add($.__views.img_user);
    ...
    $.__views.__alloyId97.add($.__views.lbl_gender_male);
    ...
    $.__views.__alloyId97.add($.__views.img_gender_male);
    ...
    $.__views.__alloyId97.add($.__views.img_gender_female);
    ...
    $.__views.__alloyId97.add($.__views.lbl_gender_female);
    ...
    continueBtnPressed ? $.__views.__alloyId98.addEventListener("click", continueBtnPressed) : __defers["$.__views.__alloyId98!click!continueBtnPressed"] = true;
    var __alloyId100 = [];
    __alloyId100.push("Open Camera");
    __alloyId100.push("Choose from Library");
    __alloyId100.push("Cancel");
    ...
    __defers["$.__views.__alloyId98!click!continueBtnPressed"] && $.__views.__alloyId98.addEventListener("click", continueBtnPressed);
