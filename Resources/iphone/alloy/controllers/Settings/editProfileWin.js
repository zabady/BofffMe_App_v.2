function Controller() {
    ...
    doneEditing ? $.__views.__alloyId79.addEventListener("click", doneEditing) : __defers["$.__views.__alloyId79!click!doneEditing"] = true;
    $.__views.win.rightNavButton = $.__views.__alloyId79;
    ...
    $.__views.__alloyId82.add($.__views.fullName);
    ...
    $.__views.__alloyId83.add($.__views.phone_numbers);
    ...
    $.__views.__alloyId84.add($.__views.phone_numbers_privacy);
    ...
    __defers["$.__views.__alloyId79!click!doneEditing"] && $.__views.__alloyId79.addEventListener("click", doneEditing);
